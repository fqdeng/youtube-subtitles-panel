...
function(ie, e) {
    ...
    function() {
        ...
        function I(t, e, n, r) {
            ...
            if (!r && (V(e), e = e || T, C)) {
                ...
                if (! (h[t + " "] || d && d.test(t))) {
                    if (c = t, f = e, 1 === p && (x.test(t) || m.test(t))) { (f = H.test(t) && U(e.parentNode) || e) == e && le.scope || ((s = e.getAttribute("id")) ? s = ce.escapeSelector(s) : e.setAttribute("id", s = S)),
                        o = (l = Y(t)).length;
        ...
        function V(e) {
            ...
            d = [], $(function(e) {
                var t;
                r.appendChild(e).innerHTML = policy.createHTML("<a id='" + S + "' href='' disabled='disabled'></a><select id='" + S + "-\r\\' disabled='disabled'><option selected=''></option></select>"),
    ...
    xe.innerHTML = policy.createHTML("<textarea>x</textarea>"),
    le.noCloneChecked = !!xe.cloneNode(!0).lastChild.defaultValue,
    xe.innerHTML = policy.createHTML("<option></option>"),
    ...
    function Ae(e, t, n, r, i) {
        for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === x(o)) ce.merge(p, o.nodeType ? [o] : o);
            ...
            u = ke[s] || ke._default,
            a.innerHTML = policy.createHTML(u[1] + ce.htmlPrefilter(o) + u[2]),
            c = u[0];
    ...
    function Fe(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            z.hasData(e) && (o = z.access(e), a = ce.extend({},
            o), z.set(t, a))
        }
    }
    function $e(n, r, i, o) {
        ...
        html: function(e) {
            ...
            function(e) {
                ...
                if ("string" == typeof e && !Oe.test(e) && !ke[(Te.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++) 1 === (t = this[n] || {}).nodeType && (ce.cleanData(Se(t, !1)), t.innerHTML = policy.createHTML(e));
                        t = 0
                    } catch(e) {}
                }
    ...
    function(e, u) {
        ce.cssHooks[u] = {
            get: function(e, t, n) {
                if (t) return ! et.test(ce.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ot(e, u, n) : Ue(e, tt,
                function() {
                    return ot(e, u, n)
                })
            },
    ...
    le.createHTMLDocument = ((Jt = C.implementation.createHTMLDocument("").body).innerHTML = policy.createHTML("<form></form><form></form>"), 2 === Jt.childNodes.length),
